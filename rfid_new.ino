...
#define FIREBASE_HOST "rfid-5e28c-default-rtdb.firebaseio.com" //Without http:// or https:// schemes
#define FIREBASE_AUTH "eY5hdgKv0aiLIcy6lz0VN75gRpA8mcPsUOYdS4Nk"
...
const char ssid[] = "Dialog 4G 267";
const char pass[] = "6f4c81f3";
    ...
    if(Firebase.getInt(firebaseData, uidPath+"/users/"+temp)){
      ...
      {  
         ...
         // json.add("status",1);
          ...
          if (Firebase.pushJSON(firebaseData, "attendence/cc", json)) {
